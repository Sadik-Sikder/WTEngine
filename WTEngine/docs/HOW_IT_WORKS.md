...
_Snapshot: latest commit `523666a` ("Evaluate bare-media-type @media blocks instead of always skipping them"), plus this commit's documentation of it._
