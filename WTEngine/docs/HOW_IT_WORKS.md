...
_Snapshot: latest commit `a03a563` ("Document the CSS class-list caching fix and its measured impact"), plus this commit's bounded thread pool for `ResourceLoader`._
